...
const DynamicInputForm = () => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (JSON.parse(localStorage.getItem("selectedOptions")).length > 0) {
      ...
      if (JSON.parse(localStorage.getItem("additionalFields")).length > 0) {
        setAdditionalFields(
          JSON.parse(localStorage.getItem("additionalFields"))
        );
      }
      if (
        JSON.parse(localStorage.getItem("selectedOptionsDimensions")).length > 0
      ) {
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <IconButton
                    onClick={() => {
                      ...
                      setMinimisedCards((prevMinimisedCards) => {
                        const updatedMinimisedCards = [...prevMinimisedCards];
                        updatedMinimisedCards[index] = !updatedMinimisedCards[
                          index
                        ];
                ...
                >
                  Please fill out the dimensions of the item. Upload a picture.
                  It will make the driver happy!
                </Typography>
                <TextField //Additional Text FOR THIS ITM
                  key={index}
                  label={`Description/Handling Instructions for this item`}
                  value={
                    additionalFields[index] ? additionalFields[index].text : ""
                  }
                  onChange={(event) =>
                    handleAdditionalFieldChange(event, index)
                  }
                  style={{
                    width: "100%",
                    margin: "7px", //center it
              ...
              >
                <TextField
                  ...
                  value={
                    selectedOptionsDimensions[index]
                      ? selectedOptionsDimensions[index].Length
                      : 0
                  }
                  //only take numbers
                  type="number"
                  ...
                  onChange={(event) => {
                    ...
                    const updatedDimensions = [...selectedOptionsDimensions];
                    ...
                    updatedDimensions[index].Length = event.target.value;
                    setSelectedOptionsDimensions(updatedDimensions);
                  }}
                  style={{
                    width: "100%",
                    margin: "5px",
                ...
                <TextField
                  ...
                  value={
                    selectedOptionsDimensions[index]
                      ? selectedOptionsDimensions[index].Width
                      : 0
                  }
                  onChange={(event) => {
                    if (parseInt(event.target.value) === NaN) {
                    ...
                    updatedDimensions[index].Width = event.target.value;
                    setSelectedOptionsDimensions(updatedDimensions);
                  }}
                ...
                <TextField
                  ...
                  value={
                    selectedOptionsDimensions[index]
                      ? selectedOptionsDimensions[index].Height
                      : 0
                  }
                  onChange={(event) => {
                    if (parseInt(event.target.value) === NaN) {
                    ...
                    updatedDimensions[index].Height = event.target.value;
                    setSelectedOptionsDimensions(updatedDimensions);
                  }}
                  style={{ width: "100%", margin: "20px" }}
                  //fit max width
              ...
              >
                <TextField
                  ...
                  value={
                    selectedOptionsDimensions[index]
                      ? selectedOptionsDimensions[index].qty
                      : 0
                  }
                  onChange={(event) => {
                    if (parseInt(event.target.value) === NaN) {
                    ...
                    updatedDimensions[index].qty = event.target.value;
                    setSelectedOptionsDimensions(updatedDimensions);
                  }}
                  style={{
                    width: "100%",
                ...
                <Button //remove selected item button
                  ...
                  onClick={() => {
                    ...
                    newSelectedOptionsDimensions.splice(index, 1);
                    setSelectedOptionsDimensions(newSelectedOptionsDimensions);
                ...
                <label htmlFor="raised-button-file">
                  <div>
                    ...
                    >
                      ...
                      {
                        <img
                          src={itemImages[index] ? itemImages[index] : ""}
                          // alt="Uploaded Image"
                          //contain
                          style={{
                            width: "100px",
            ...
            >
              {Object.keys(materials).map((material) => (
                ...
                <FormControlLabel
                    ...
                    <Checkbox
                      ...
                      checked={
                        selectedOptionsMaterials[index]
                          ? selectedOptionsMaterials[index][material]
                          : false
                      }
                      onChange={(event) =>
                  ...
                  style={{
                    backgroundColor: selectedOptionsMaterials[index]
                      ? selectedOptionsMaterials[index][material]
                        ? "#3f51b5"
                        : "#fff"
                      : "#fff",
