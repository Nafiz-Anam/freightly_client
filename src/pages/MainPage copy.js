...
function MainPage() {
    ...
    const [extraPickULiftingpHelpPrice, setExtraPickUpFloorHelpPrice] =
        React.useState(0);
    //extra drop help price
    const [extraDropLiftingHelpPrice, setExtraDropLiftingHelpPrice] =
        React.useState(0);
        ...
        const intervalId = setInterval(() => {
            ...
            if (localStorage.getItem("selectedOptions")) {
                ...
                for (
                    let i = 0;
                    i <
                    JSON.parse(localStorage.getItem("selectedOptions")).length;
                    i++
                ) {
                    ...
                    items.push([
                        ...
                        //materials
                        JSON.parse(
                            localStorage.getItem("selectedOptionsMaterials")
                        )[i],
                        //item im
                ...
                axios
                    .post(
                        "https://us-central1-freightly-admin.cloudfunctions.net/api/updateData",
                        {
                            ...
                            pickupData: JSON.parse(
                                localStorage.getItem("pickupData")
                            ),
                            //selected date, name, email, and phone of dropoff from step 4
                            dropData: JSON.parse(
                                localStorage.getItem("dropData")
                            ),
                            ...
                            //extra pickup help
                            extraPickupHelp:
                                localStorage.getItem("extraPickupHelp"),
                            //extra pickup lifting help
                            extraPickupFloorHelp: localStorage.getItem(
                                "extraPickupFloorHelp"
                            ),
                            extraDropFloorHelp:
                                localStorage.getItem("extraDropFloorHelp"),
                            //extra drop help
                            extraDropHelp:
                                localStorage.getItem("extraDropHelp"),
                            //time slots prices
                            timeSlotPrices:
                                (parseFloat(
                                    localStorage.getItem("pickupTimeSlotPrice")
